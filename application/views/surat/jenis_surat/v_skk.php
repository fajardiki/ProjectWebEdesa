	...
	<div class="container"> <!-- pakai class="tepi" -->
		...
		<div class="isi">
			<div class="judul" style="text-align: center;">
				<h3 style="margin-bottom: -5px;"><u>SURAT KETERANGAN KEHILANGAN KK</u></h3>
				<h4>Nomor :</h4>
			</div>
			<br>
			<div>
				...
				<table>
					...
					<tr>
						<td>13.</td>
						<td>Keterangan</td>
						<td>: Bahwa nama yang tersebut di atas benar - benar <b>Telah Kehilangan Kartu Keluarga.</b></td>
					</tr>
				</table>
