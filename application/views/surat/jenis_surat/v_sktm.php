	...
	<div class="container"> <!-- pakai class="tepi" -->
		...
		<div class="isi">
			<div class="judul" style="text-align: center;">
				<h3 style="margin-bottom: -5px;"><u>SURAT KETERANGAN TIDAK MAMPU</u></h3>
				<h4>Nomor :</h4>
			</div>
			<br>
			<div>
				...
				<table>
					...
					<tr>
						<td>12.</td>
						<td>Keterangan</td>
						<td>: Bahwa nama yang tersebut di atas benar - benat Penduduk Desa Trebungan Kecamatan Mlandingan Kabupaten Situbondo dan benar - benar berasal dari keluarga yang tidak mampu.</td>
					</tr>
				</table>
